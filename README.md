...
The BaMFA model was implemented in Python (v.3.9.16), and PyMC3 (v3.11.2) was used to conduct Bayesian inference via the No-U-Turn-Sampler algorithm. All input and output datasets are stored in the <a href="https://doi.org/10.5281/zenodo.10828214" style=" text-decoration: none !important; color:red !important;">data repository &#10140;</a> hosted on Zenodo.
